...
<div class="box">
	...
	<div class="pull-right">
		<img src="https://chart.googleapis.com/chart?chs=50x50&cht=qr&chl=http://localhost/adiwiyata/page-user/tanamanobat/lihat.php?id=<?= $data['id_tanamanobat']; ?>&choe=UTF-8">
	</div>
