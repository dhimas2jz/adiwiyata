...
<div class="box">
	...
	<div class="pull-right">
		<img src="https://chart.googleapis.com/chart?chs=50x50&cht=qr&chl=http://localhost/adiwiyata/page-user/tanamanhias/lihat.php?id=<?= $data['id_tanamanhias']; ?>&choe=UTF-8">
	</div>
